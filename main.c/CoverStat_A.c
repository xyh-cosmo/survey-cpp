...
int main(int argc, char *argv[]) {
	...
	printf("--> processing %s (any filer once)\n",argv[1]);

    sprintf(file_out,"%s_area_A.txt",argv[2]);
    sprintf(file_out_deep,"%s_deep_A.txt",argv[2]);
    sprintf(file_out_norm,"%s_norm_A.txt",argv[2]);
    // sprintf(file_out_disk,"%s_disk_A.txt",argv[2]);
    sprintf(file_out_low,"%s_low_A.txt",argv[2]);
