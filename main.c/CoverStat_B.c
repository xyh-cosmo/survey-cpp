...
int main(int argc, char *argv[]) {
    ...
    printf("--> processing %s (all filter at least once)\n",argv[1]);

	sprintf(file_out,"%s_area_B.txt",argv[2]);
    sprintf(file_out_deep,"%s_deep_B.txt",argv[2]);
    sprintf(file_out_norm,"%s_norm_B.txt",argv[2]);
    // sprintf(file_out_disk,"%s_disk_B.txt",argv[2]);
    sprintf(file_out_low,"%s_low_B.txt",argv[2]);
    ...
    // FILE *fp_out_disk = fopen(file_out_disk,"w");
